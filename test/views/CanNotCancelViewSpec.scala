...
import views.html.CanNotCancelView

class CanNotCancelViewSpec extends ViewBehaviours {

  val departuresUrl = "departuresUrl"
  val contactUrl    = "https://www.gov.uk/new-computerised-transit-system"

  override def view: HtmlFormat.Appendable =
    injector.instanceOf[CanNotCancelView].apply(departuresUrl)(fakeRequest, messages)
